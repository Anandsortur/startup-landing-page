export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 text-center p-8">
      {/* Hero Section */}
      ...
      {/* Scroll indicator */}
      <div className="mt-16 animate-bounce text-gray-500">↓</div>
    </section>
  );
}
